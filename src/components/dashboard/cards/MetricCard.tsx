    ...
    >
      <div className="flex flex-row items-start justify-between space-y-0 pb-2">
        <div className="flex items-center gap-2.5">
          ...
          <Typography.Text className="text-sm font-medium text-muted-foreground">{title}</Typography.Text>
        </div>
      ...
      {footer && <div className="pt-0 text-xs text-muted-foreground">{footer}</div>}
    </Card>
  )
}
