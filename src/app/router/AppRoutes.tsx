...
const DashboardAdmin = React.lazy(() => import("@/pages/DashboardAdmin").then((m) => ({ default: m.DashboardAdmin })));
const Products = React.lazy(() => import("@/pages/system/Products").then((m) => ({ default: m.Products })));
const Categories = React.lazy(() => import("@/pages/system/Categories").then((m) => ({ default: m.Categories })));
...
const VouchersPage = React.lazy(() => import("@/pages/admin/VouchersPage").then((m) => ({ default: m.VouchersPage })));
...
export const AppRoutes = () => {
  return (
    <Routes>
      ...
      >
        <Route path="/system/dashboard-admin" element={<Lazy><DashboardAdmin /></Lazy>} />

        <Route path="/system/orders" element={<Lazy><OrdersPage /></Lazy>} />
        <Route path="/system/products" element={<Lazy><Products /></Lazy>} />
        <Route path="/system/categories" element={<Lazy><Categories /></Lazy>} />
        <Route path="/system/users" element={<Lazy><Users /></Lazy>} />
        <Route path="/system/profile" element={<Lazy><ProfilePage /></Lazy>} />
        <Route path="/system/team-chat" element={<TeamChatPage />} />
        <Route path="/admin/vouchers" element={<Lazy><VouchersPage /></Lazy>} />
