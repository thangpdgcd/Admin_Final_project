...
function mapApiMessageRow(row: unknown, myAdminId: number | null, convId: number, peerIncomingRole = "staff") {
...
export function useAdminStaffChat(selectedStaffId: string) {
