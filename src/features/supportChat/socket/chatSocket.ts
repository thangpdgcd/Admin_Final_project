...
import { chatSocketDebug, chatSocketDebugWarn, isChatSocketDebug } from "@/features/supportChat/socket/chatSocketDebug";
...
function attachLifecycleDebug(s: Socket<ServerToClientEvents, ClientToServerEvents>) {
