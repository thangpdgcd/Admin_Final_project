...
const extractStringImageValue = (value: unknown): string | undefined => {
...
const resolveProductImageCandidates = (product: ProductEntity): string[] => {
...
const mapProductToRow = (product: ProductEntity): ProductRow => {
  const id = String(
    (product as ProductEntity & { id?: string; productId?: string | number; productsId?: string | number })
      ._id ||
      (product as ProductEntity & { id?: string; productId?: string | number; productsId?: string | number })
        .id ||
      (product as ProductEntity & { id?: string; productId?: string | number; productsId?: string | number })
